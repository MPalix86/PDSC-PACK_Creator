...
public class XmlTagSelection implements Transferable , ClipboardOwner{
	...
	private static final int XML_TAG_TO_JSON = 2;
	private static final int XML_TAG_TO_XML_TEXT = 3;
	
	public static DataFlavor xmlTagFlavor = new DataFlavor (XmlTag.class , "Xml tag");
	public static DataFlavor JSONFlavor = new DataFlavor (XmlTag.class , "Xml tag JSON");
	public static DataFlavor xmlTextFlavor = new DataFlavor (XmlTag.class , "Xml tag in xml formatted text");
	...
	public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException, IOException {
		...
		else if(flavor.equals(flavors[XML_TAG_TO_JSON])) {
			ObjectMapper mapper = new ObjectMapper();
			String JSONTag = mapper.writeValueAsString(tag);
			return JSONTag;
		}
		else if(flavor.equals(flavors[XML_TAG_TO_XML_TEXT])) {
