...
public class Dname extends XmlAttribute{
	
	/** attribute's name */
	private final static String name = "Dname";
	...
	/**
	 * Create new instance of Dname attribute
	 * 
	 * @param required attribute's obligatoriness
	 */
	
	public Dname(boolean required, XmlTag tag) {
