...
public class Url extends XmlTagAbstract{
	
	/** tag's name */
	private final static String name = "url";
	...
	public Url(boolean required, XmlTag parent, int max) {
	...
	public Url(boolean required, XmlTag parent, int max, String defaultContent) {
