...
public class Pre_Include_Local_Component_h extends XmlStandardTag {
	
	
	/** tag's name */
	private final static String name = "Pre_Include_Local_Component_h";
	...
	public Pre_Include_Local_Component_h(boolean required, XmlTag parent, int max) {
	...
	public Pre_Include_Local_Component_h(boolean required, XmlTag parent, int max, String defaultContent) {
