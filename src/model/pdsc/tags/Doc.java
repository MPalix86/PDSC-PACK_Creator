...
public class Doc extends XmlStandardTag {
	...
	public Doc(boolean required, XmlTag parent, int max) {
	...
	public Doc(boolean required, XmlTag parent, int max, String defaultContent) {
