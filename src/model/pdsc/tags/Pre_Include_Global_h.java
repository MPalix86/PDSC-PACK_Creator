...
public class Pre_Include_Global_h extends XmlStandardTag {
	
	
	/** tag's name */
	private final static String name = "Pre_Include_Global_h";
	...
	public Pre_Include_Global_h(boolean required, XmlTag parent, int max) {
	...
	public Pre_Include_Global_h(boolean required, XmlTag parent, int max, String defaultContent) {
