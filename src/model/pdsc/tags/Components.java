...
public class Components extends XmlStandardTag{
	
	
	/** tag's name */
	private final static String name = "components";
	...
	public Components(boolean required, XmlTag parent, int max) {
	...
	public Components(boolean required, XmlTag parent, int max, String defaultContent) {
	...
	protected void addChildren() {
		this.addChild(new Component(true, this, MAX_OCCURENCE_NUMBER));
		this.addChild(new Bundle(true, this, MAX_OCCURENCE_NUMBER));
	}
