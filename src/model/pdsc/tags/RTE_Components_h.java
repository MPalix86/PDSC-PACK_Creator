...
public class RTE_Components_h extends XmlStandardTag {
	
	
	/** tag's name */
	private final static String name = "RTE_Components_h";
	...
	public RTE_Components_h(boolean required, XmlTag parent, int max) {
	...
	public RTE_Components_h(boolean required, XmlTag parent, int max, String defaultContent) {
